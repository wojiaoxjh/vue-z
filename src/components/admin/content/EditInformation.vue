...
export default {
  ...
  methods: {
    ...
    onSubmit () {
      this.$axios
          .post('http://localhost:9090/admin/content/movie/update'+'?changeCategories='+this.categoriesChanged, {
            id: this.form.id,
...
<style lang="scss" scoped>
  ...
  ::v-deep p .rate-item lable.el-form-item__label {
